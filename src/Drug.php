...
class Drug extends BaseType implements DrugContract, MedicalEntityContract, SubstanceContract, ThingContract
{
     ...
     * @return static
     *
     * @see schema:administrationRoute
     * @see https://health-lifesci.schema.org
     */
     ...
     * @return static
     *
     * @see schema:breastfeedingWarning
     * @see https://health-lifesci.schema.org
     */
     ...
     * @return static
     *
     * @see schema:clincalPharmacology
     * @see https://health-lifesci.schema.org
     */
     ...
     * @return static
     *
     * @see schema:clinicalPharmacology
     * @see https://health-lifesci.schema.org
     */
     ...
     * @return static
     *
     * @see schema:includedInHealthInsurancePlan
     ...
     * @return static
     *
     * @see schema:isAvailableGenerically
     * @see https://health-lifesci.schema.org
     */
