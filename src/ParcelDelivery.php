...
class ParcelDelivery extends BaseType implements ParcelDeliveryContract, IntangibleContract, ThingContract
{
     ...
     * @return static
     *
     * @see schema:expectedArrivalFrom
     */
     ...
     * @return static
     *
     * @see schema:expectedArrivalUntil
     */
